...
bool rkf45(struct rkf *p)
{
	...
	if(MFlag != 1)//���� ��� ��� �� ������ ��������� � rkf45
	{
		...
		{//p->flag = 3,4,5,6,7 ��� 8
			...
			{
				if(p->flag == 4) w->nfe = 0;
				else if(p->flag != 5 || p->ae <= 0) return true;//�������������� ������ ����������, �.�.
				//������������ �� �������� ����������, ��������������� ��������� p->flag = 5,6,7 ��� 8
			}
			//�������������� �������� p->flag, ������������� ��� ���������� ���������
			p->flag = w->JFlag;
...
{
	Float c = (Float)((Float)3.0-(Float)sqrt(5.0))/(Float)2,//� - ��� ���������� � ������� ��������, �������� � �������� �������
		d, e = (Float)0, eps = (Float)sqrt(EPSILON),//eps �������������� ����� ����������� ����� �� ������������� �������� ��������
	...
	while(1)
	{
		...
		do
		{
			...
			if(ABS(e) >= tol1 && ABS(fa) > ABS(fb))
			{
				...
				//��������� �� ������������
				if(((Float)2*p) >= ((Float)3*xm*q - ABS(tol1*q)) || p >= ABS(e*q/(Float)2)) e = d = xm;//��������
				else
				{
					e = d;
					d = p/q;
